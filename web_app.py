...
def _gdrive_redirect_uri():
    # Use APP_URL env var (set to https://franciskusi.dev in Railway),
    # defaulting to the production domain if not configured.
    base = os.environ.get("APP_URL", "https://franciskusi.dev").rstrip("/")
